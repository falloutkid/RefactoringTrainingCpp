...
namespace Test
{
	...
	public:
		...
		TEST_METHOD(ExecuteSQLは指定したテーブル名を取得し対応するファイルを参照できます)
		{
			char* sql =
				"SELECT * "
				"FROM TABLE2";
		...
		TEST_METHOD(ExecuteSQLは二つののテーブルを読み込んで全ての組み合わせを出力します)
		{
			char* sql =
				"SELECT * "
				"FROM TABLE1, TABLE2";
		...
		TEST_METHOD(ExecuteSQLは三つ以上のテーブルを読み込みんで全ての組み合わせを出力します)
		{
			char* sql =
				"SELECT * "
		...
		TEST_METHOD(ExecuteSQLはSQLECT句にテーブルと一緒に指定した列名を指定してSQLを実行できます)
		{
			char* sql =
				"SELECT String "
				"FROM TABLE1";
		...
		TEST_METHOD(ExecuteSQLはSQLECT句に複数のテーブルと一緒に指定した列名を指定してSQLを実行できます)
		{
			char* sql =
		...
		TEST_METHOD(ExecuteSQLはSQLECT句に三つ以上のテーブルと一緒に指定した列名を指定してSQLを実行できます)
		{
			char* sql =
		...
		TEST_METHOD(ExecuteSQLは複数ののテーブルを読み込みんでテーブル名で区別してテーブルと一緒に指定した列名を指定することができます)
		{
			char* sql =
				"SELECT Table1.Integer "
				"FROM TABLE1, TABLE2";
		...
		TEST_METHOD(ExecuteSQLはORDER句にSELECTで指定されなかった入力の最後の列を指定することができます)
		{
			char* sql =
				"SELECT Integer "
				"ORDER BY String "
		...
		TEST_METHOD(ExecuteSQLはORDER句にテーブル名付のテーブルと一緒に指定した列名を指定してテーブルを選択することができます)
		{
			char* sql =
				"SELECT *"
		...
		TEST_METHOD(ExecuteSQLはWHERE句でSELECT句で指定していない入力の最後の列がテーブル名を指定せずに条件の指定ができます)
		{
			char* sql =
				"SELECT Integer "
				"WHERE String = \'B\' "
		...
		TEST_METHOD(ExecuteSQLはWHERE句でSELECT句で指定していない入力の最後の列がテーブル名を指定して条件の指定ができます)
		{
			char* sql =
				"SELECT Integer "
		...
		TEST_METHOD(ExecuteSQLはWHERE句にテーブル名付のテーブルと一緒に指定した列名を指定してテーブルを選択することができます)
		{
			char* sql =
				"SELECT *"
		...
		TEST_METHOD(ExecuteSQLはSELECTキーワードを大文字でも小文字でも識別します)
		{
			char* sql =
				"select * "
				"FROM TABLE1";
		...
		TEST_METHOD(ExecuteSQLはFROMキーワードを大文字でも小文字でも識別します)
		{
			char* sql =
				"SELECT * "
				"from TABLE1";
		...
		TEST_METHOD(ExecuteSQLはORDERキーワードを大文字でも小文字でも識別します)
		{
			char* sql =
				"SELECT * "
				"order BY String "
		...
		TEST_METHOD(ExecuteSQLはBYキーワードを大文字でも小文字でも識別します)
		{
			char* sql =
				"SELECT * "
				"ORDER by String "
		...
		TEST_METHOD(ExecuteSQLはASCキーワードを大文字でも小文字でも識別します)
		{
			char* sql =
				"SELECT String1, String2 "
				"ORDER BY String1 asc, String2 "
		...
		TEST_METHOD(ExecuteSQLはDESCキーワードを大文字でも小文字でも識別します)
		{
			char* sql =
				"SELECT String1, String2 "
				"ORDER BY String1 desc, String2 "
		...
		TEST_METHOD(ExecuteSQLはWHEREキーワードを大文字でも小文字でも識別します)
		{
			char* sql =
				"SELECT * "
				"where Integer = 2 "
		...
		TEST_METHOD(ExecuteSQLはANDキーワードを大文字でも小文字でも識別します)
		{
			char* sql =
				"SELECT * "
				"WHERE 1 < Integer and Integer < 3 "
		...
		TEST_METHOD(ExecuteSQLはORキーワードを大文字でも小文字でも識別します)
		{
			char* sql =
				"SELECT * "
				"WHERE Integer < 2 or 2 < Integer "
		...
		TEST_METHOD(ExecuteSQLはFrom句のテーブル名を大文字でも小文字でも識別します)
		{
			char* sql =
				"SELECT * "
				"FROM table1";
		...
		TEST_METHOD(ExecuteSQLはSELECT句のテーブルと一緒に指定した列名を大文字でも小文字でも識別します)
		{
			char* sql =
				"SELECT sTRING "
				"FROM table1";
		...
		TEST_METHOD(ExecuteSQLはSELECT句のテーブル名を大文字でも小文字でも識別します)
		{
			char* sql =
		...
		TEST_METHOD(ExecuteSQLはORDER句のテーブルと一緒に指定した列名を大文字でも小文字でも識別しじます)
		{
			char* sql =
				"SELECT * "
				"ORDER BY sTRING "
		...
		TEST_METHOD(ExecuteSQLはORDER句のテーブル名を大文字でも小文字でも識別しじます)
		{
			char* sql =
				"SELECT * "
				"ORDER BY unordered.String "
